...
void Moves::callForMove(){
    ...
    if (endPosition->getPiece()->getPieceType() == PAWN) {
        if (endPosition->getPiece()->getColor() == WHITE) {
            if (endPosition->getSquareY() == 0) {
                cout << "Pick a piece to promote to: KNIGHT BISHOP ROOK QUEEN" << endl;
                cin >> promotion;
                while ((promotion != "KNIGHT") && (promotion != "BISHOP") && (promotion != "ROOK") && (promotion != "QUEEN")) {
                    cout << promotion;
                    cout << "Inputted piece is not valid" << endl;
                    cin >> promotion;
                }
                delete endPosition->getPiece();
                if (promotion == "KNIGHT") {
                    endPosition->placedPiece(new Knight(WHITE));
                }
                else if (promotion == "BISHOP") {
                    endPosition->placedPiece(new Bishop(WHITE));
                }
                else if (promotion == "ROOK") {
                    endPosition->placedPiece(new Rook(WHITE));
                }
                else if (promotion == "QUEEN") {
                    endPosition->placedPiece(new Queen(WHITE));
                }
            }
        }
        else if (endPosition->getPiece()->getColor() == BLACK) {
            if (endPosition->getSquareY() == 7) {
                cout << "Pick a piece to promote to: KNIGHT BISHOP ROOK QUEEN" << endl;
                cin >> promotion;
                while ((promotion != "KNIGHT") && (promotion != "BISHOP") && (promotion != "ROOK") && (promotion != "QUEEN")) {
                    cout << "Inputted piece is not valid" << endl;
                ...
                delete endPosition->getPiece();
                if (promotion == "KNIGHT") {
                    endPosition->placedPiece(new Knight(BLACK));
                }
                else if (promotion == "BISHOP") {
                    endPosition->placedPiece(new Bishop(BLACK));
                }
                else if (promotion == "ROOK") {
                    endPosition->placedPiece(new Rook(BLACK));
                }
                else if (promotion == "QUEEN") {
                    endPosition->placedPiece(new Queen(BLACK));
                }
            }
        }
    }
